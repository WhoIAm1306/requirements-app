...
const description = computed(() =>
  props.mode === 'requirements'
    ? 'Загрузите .xlsx файл по шаблону. Колонка «Идентификатор задачи» необязательна: если пусто — номер сформируется с учётом очереди и ГК; иначе будет использовано указанное значение (должно быть уникальным).'
    : props.mode === 'tz'
