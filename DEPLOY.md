...
- **`FRONTEND_ORIGIN`** — полный URL, с которого пользователи открывают сайт в браузере, например `http://203.0.113.10:8080` или `https://requirements.company.ru`. Нужен для **CORS** (иначе браузер может блокировать запросы к API).
